...
import v1 "github.com/stkr89/livegig-common/pb/registrationsvc/v1"

// RegistrationSvcClient is an autogenerated mock type for the RegistrationSvcClient type
type RegistrationSvcClient struct {
	mock.Mock
}

// Register provides a mock function with given fields: ctx, in, opts
func (_m *RegistrationSvcClient) Register(ctx context.Context, in *v1.RegisterRequest, opts ...grpc.CallOption) (*v1.RegisterResponse, error) {
